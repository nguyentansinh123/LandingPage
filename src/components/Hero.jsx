            ...
            <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem]">
                <h1 className='h1 mb-6'>
                    ...
                    <span className='inline-block relative'>
                        Brainwave 
                        <img src={curve} alt="" className='absolute top-full left-0 w-full xl:-mt-2' width={624} height={28}/>
                    </span>
                </h1>
            ...
            <div className='relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-22'>
                <div className='relative z-1 p-0.5 rounded=2xl bg-conic-gradient'>
                    <div className='relative bg-n-8 rounded-[1rem]'>
                        <div className='bg-n-10 rounded-t-[0.9rem]'></div>

                            <div className='aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]'>
                                <img src={robot} className='w-full scale-[1.7] translate-y-[8%] md:scale-[1] md:-translate-y-[10%] lg:-translate-y-[23%]' width={1440} height={1800} alt="" />
